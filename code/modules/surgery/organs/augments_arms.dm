...
/obj/item/organ/cyberimp/arm/proc/Retract()
	...
	owner.visible_message(span_notice("[owner] retracts [holder] back into [owner.p_their()] [zone == BODY_ZONE_R_ARM ? "right" : "left"] arm."),
		span_notice("[holder] snaps back into my [zone == BODY_ZONE_R_ARM ? "right" : "left"] arm."),
...
/obj/item/organ/cyberimp/arm/proc/Extend(obj/item/item)
	...
	owner.visible_message(span_notice("[owner] extends [holder] from [owner.p_their()] [zone == BODY_ZONE_R_ARM ? "right" : "left"] arm."),
		span_notice("I extend [holder] from my [zone == BODY_ZONE_R_ARM ? "right" : "left"] arm."),
		span_hear("I hear a short mechanical noise."))
	playsound(get_turf(owner), 'sound/blank.ogg', 50, TRUE)
...
/obj/item/organ/cyberimp/arm/gun/emp_act(severity)
	...
	if(prob(30/severity) && owner && !(organ_flags & ORGAN_FAILING))
		...
		to_chat(owner, span_danger("I feel an explosion erupt inside my [zone == BODY_ZONE_R_ARM ? "right" : "left"] arm as my implant breaks!"))
...
/obj/item/organ/cyberimp/arm/toolset/emag_act()
	if(!(locate(/obj/item/kitchen/knife/combat/cyborg) in items_list))
		to_chat(usr, span_notice("I unlock [src]'s integrated knife!"))
