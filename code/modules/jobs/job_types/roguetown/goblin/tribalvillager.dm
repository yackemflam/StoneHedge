...
/datum/outfit/job/roguetown/tribevillager/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/polearms, 3, TRUE) //classic tribal spear moment.
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/crafting, 4 , TRUE) //builders
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/masonry, 4, TRUE) // builders
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/carpentry, 4, TRUE) //builders
