<<<<<<<< HEAD:code/modules/jobs/job_types/roguetown/nobility/judge.dm
...
/datum/job/roguetown/marshal
	title = "Royal Marshal"
	flag = MARSHAL
>>>>>>>> dd0697d639ed4e6e741c03f170fffa57ab710c07:code/modules/jobs/job_types/roguetown/nobility/marshal.dm
