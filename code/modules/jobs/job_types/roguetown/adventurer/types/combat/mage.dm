...
/datum/outfit/job/roguetown/adventurer/mage/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Elementalist")
			...
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/wrestling, pick(0,1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/unarmed, pick(0,1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/swimming, 1, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/climbing, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, 1, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/knives, pick(0,1,2), TRUE)
		...
		if("Enchanter")
			...
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/wrestling, pick(0,1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/unarmed, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/swimming, 1, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/climbing, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, 1, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/knives, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/crafting, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/blacksmithing, pick(1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/armorsmithing, pick(1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/weaponsmithing, pick(1,2), TRUE)
		...
		if("Spellblade")
			...
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, pick(2,3), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/knives, pick(0,1,2), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/crafting, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/medicine, pick(0,1), TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 1, TRUE)
