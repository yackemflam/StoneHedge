...
/datum/outfit/job/roguetown/adventurer/blacksmith/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/weaponsmithing, 3, TRUE) //removes a lot of the combat skills for 3 in all smithing, would not be opposed to making it maces 1 instead of 2 if you really wanna disarm towners
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/traps, 1, TRUE) //intended to make smiths be able to make mantraps (they are made of metal)
