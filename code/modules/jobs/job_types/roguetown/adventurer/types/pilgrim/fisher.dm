...
/datum/outfit/job/roguetown/adventurer/fisher/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, pick(0,0,1), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/axes, pick(0,1,1), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/maces, pick(0,1,1), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/crossbows, pick(0,1,1), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, pick(2,2,3), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/bows, pick(1,1,2), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/wrestling, pick(1,1,2), TRUE)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/unarmed, pick(1,2,2,3), TRUE)
